...
const VideoDownloader = () => {
  ...
  const [downloads, setDownloads] = useState<DownloadItem[]>([
    {
      id: '1',
      title: 'Playstation-Leak UFO-Aussagen Samsung-Neuheiten Wechselrichter-Wirbel News der Woche',
      url: 'https://example.com/video1',
      progress: 16,
      status: 'downloading',
      format: 'MP4',
      quality: '1080p',
      size: '45.7 MB von 277.9 MB',
      duration: '1 Minute',
      thumbnail: '/placeholder.svg'
    },
    {
      id: '2',
      title: 'Sony X85L im Test Besser als die teureren Geschwister',
  ...
  const handleDownload = () => {
    ...
    setTimeout(() => {
      setDownloads(prev => prev.map(d => 
        d.id === newDownload.id 
          ? { ...d, status: 'downloading', title: 'Video wird heruntergeladen...', size: '25.4 MB von 156.8 MB' }
          : d
      ));
    ...
    toast({
      ...
      description: "Der Download wurde zur Warteschlange hinzugefügt."
    });
  };
  ...
  const handleActivateLicense = () => {
    toast({
      ...
      description: "Aktivieren Sie die Lizenz, um mehr herunterzuladen."
    });
  };
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">[Nicht aktiviert]</p>
            </div>
          </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-700 mb-1 block">Wählen</label>
                    <Select value={quality} onValueChange={setQuality}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="best">Beste Qualität</SelectItem>
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-700 mb-1 block">Für</label>
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-700 mb-1 block">Speichern in</label>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-sm text-gray-600">2 Elemente</div>
                </div>
              </CardHeader>
              <CardContent>
                <Tabs defaultValue="alle" className="w-full">
                  <TabsList className="grid w-full grid-cols-5">
                    ...
                    <TabsTrigger value="kanale">Kanäle</TabsTrigger>
                  </TabsList>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center space-x-4 text-sm text-gray-600 mt-1">
                            ...
                            <Badge variant={download.status === 'completed' ? 'default' : download.status === 'downloading' ? 'secondary' : 'outline'}>
                              ...
                              {download.status === 'downloading' && 'Lädt...'}
                              {download.status === 'waiting' && 'Wartend'}
                          ...
                          {download.status === 'downloading' && (
                            <div className="mt-2">
                              ...
                              <div className="text-xs text-gray-500 mt-1">{Math.round(download.progress)}% abgeschlossen</div>
                            </div>
                          )}
                        </div>
                      </div>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="text-center space-y-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Automatische Anpassung von Einstellungen</h3>
                    <p className="text-sm text-gray-600 mt-2">
                      Einige Objekte sind möglicherweise nicht in der gewählten Qualität, dem gewählten Format und anderen Einstellungen verfügbar. In solchen Fällen werden sie in der Qualität heruntergeladen, die Ihren Präferenzen am nächsten kommt.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="bg-green-500 text-white">
              <CardContent className="p-6">
                <div className="text-center space-y-4">
                  ...
                  <div>
                    <p className="font-medium">tägliche Downloads übrig</p>
                    <p className="text-sm opacity-90">Aktivieren Sie die Lizenz, um mehr herunterzuladen</p>
                  </div>
                  <Button 
